...
products.delete('/:id', jwtmiddelware_1.verifyAdmin, productValidator_1.showOrDelProductValidator, productcontroller.delete);
...
products.get('/:id', productValidator_1.showOrDelProductValidator, productcontroller.show);
products.post('/comments', jwtmiddelware_1.default, productValidator_1.createCommentValidator, productcontroller.createcomment);
products.get('/comments/:prodId', productValidator_1.productIdValidator, productcontroller.getproductcomments);
products.get('/showstars/:prodId', productValidator_1.productIdValidator, productcontroller.getproductstars);
