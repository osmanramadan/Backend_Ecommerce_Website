...
addresses.get('/:email', jwtmiddelware_1.default, addressValidator_1.getUserAddressValidator, AddressController.viewuseraddress);
addresses.post('/', jwtmiddelware_1.default, addressValidator_1.addAddressValidator, AddressController.addaddress);
addresses.delete('/:email', jwtmiddelware_1.default, addressValidator_1.deleteAddressValidator, AddressController.deleteuseraddress);
addresses.put('/:email', jwtmiddelware_1.default, addressValidator_1.updateAddressValidator, AddressController.updateuseraddress);
